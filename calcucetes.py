...
def calculadora_cetes(monto, tasa, dt, plazo):
    ...
    # Monto final anual: M*(1+T_plazo)^P
    Mf_anual = monto * (1 + T_plazo) ** plazos_equivalentes
...
monto = st.sidebar.number_input("Monto a invertir", min_value=0.0, value=10000.0)
tasa = st.sidebar.number_input("Tasa anual (%)", min_value=0.0, value=7.35)
